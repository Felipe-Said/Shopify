 ...
 */
export function getDelegateManager(request: CartifyRequest) {
 ...
 */
export function hasDelegate(id: string, request: CartifyRequest): boolean {
...
export function getDelegates(request: CartifyRequest): Record<string, any> {
