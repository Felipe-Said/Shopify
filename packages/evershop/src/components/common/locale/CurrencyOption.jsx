...
function CurrencyOptions(props) {
  ...
  const options = [
    ...
    { value: 'CRC', text: 'Costa Rican ColÃ³n' },
    ...
    { value: 'ISK', text: 'Icelandic KrÃ³na' },
    ...
    { value: 'SVC', text: 'Salvadoran ColÃ³n' },
    ...
    { value: 'VEB', text: 'Venezuelan BolÃ­var' },
